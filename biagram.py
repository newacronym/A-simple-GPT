...
# dataset ~1M tokens (character level) =  ~300K tokens (subwords level)
# model Parametres ~10M
...
# Decoder Only Transformer, with only self attention
...
class Block(nn.Module):
  """ Transformer block: communication followed by computation attention -> ffwd network """
...
# print the numbers of parameters in the model
